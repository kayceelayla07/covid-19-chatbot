...
function sendmsg() {
    ...
    } else if ((msg.toLowerCase().indexOf("passed to newborn baby") >= 0)) {
    ...
    } else if ((msg.toLowerCase().indexOf("can a mask protect me") >= 0)||(msg.toLowerCase().indexOf("wear a mask") >= 0)) {
    ...
    } else if ((msg.toLowerCase().indexOf("effect of covid-19 on children") >= 0)) {
